...
namespace engine
{
	namespace graphic
	{
		...
		{
		public:
			static ITextureCubeMap * CreateTexture(const size_t width, const size_t heigth, const ETextureFormat usageFormat, const ETextureSizedFormat internalFormat, const EDataType dataType);
